...
#pragma config(Sensor, dgtl9,  sonarFront,     sensorSONAR_cm)
#pragma config(Sensor, dgtl11, sonarBack,      sensorSONAR_cm)
#pragma config(Motor,  port2,           rightDrive,    tmotorVex393TurboSpeed_MC29, openLoop, driveRight, encoderPort, dgtl1)
#pragma config(Motor,  port3,           leftDrive,     tmotorVex393TurboSpeed_MC29, openLoop, reversed, driveLeft, encoderPort, dgtl3)
