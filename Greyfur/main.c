...
#pragma config(Motor,  port1,           conveyMotor,   tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port10,          strafeMotor,   tmotorVex393_HBridge, openLoop, reversed)
...
#define LIFT_MAX 1066 /**FUCKING SET THIS VALUE YOU LAZY WHORES**/
#define LIFT_MIN 0 /**FUCKING SET THIS VALUE YOU LAZY WHORES**/
